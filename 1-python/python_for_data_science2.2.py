# -*- coding: utf-8 -*-
"""
Created on Tue Apr  14 15:12:24 2023
...
# Using pandas.merge()
df3= pd.merge(df1,df2)#It will merge the rows with same index and combine all the columns in both the dataframe of respective df
